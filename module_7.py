...
def exec_waypoint_nav_demo(args):
    ...
    with make_carla_client(args.host, args.port) as client:
        ...
        lp_2d = lv.LivePlotter(tk_title="Controls Feedback2")
        ...
        steer_fig = lp_2d.plot_new_dynamic_figure(title="Steer")
        steer_fig.add_graph("steer", 
                              label="steer", 
                              window_size=TOTAL_EPISODE_FRAMES)
        # Add Yaw signals graph
        Yaw_fig = lp_2d.plot_new_dynamic_figure(title="Yaw")
        ...
        store_trajectory_plot(Yaw_fig.fig, 'Yaw_output.png')
